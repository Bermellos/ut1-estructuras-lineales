...
public class GestionSucursales 
{
    ...
    public static void main(String args[]) throws FileNotFoundException
    {
        ...
        Scanner archivo = new Scanner(new File("src/main/java/com/example/suc1.txt"));
        Scanner archivo2 = new Scanner(new File("src/main/java/com/example/suc2.txt"));
        Scanner archivo3 = new Scanner(new File("src/main/java/com/example/suc3.txt"));
